    ...
    <div>
      <Slider {...settings}>
        <div className='!flex items-center bg-gray-100 px-6'>
          ...
          <img className='w-full max-w-sm' src='https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/17d79451-f6f2-4b5e-94ee-5c9ba460c2ef/AIR+MAX+DN+OLY.png' alt='Air Max' />
        </div>
        <div className='!flex items-center bg-gray-100 px-6'>
          <div>
            <div className='text-6xl font-bold'>En Kaliteli Ayakkabilar Burada</div>
          ...
          <img className='w-full max-w-sm' src='https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/28d43163-2879-40bb-985b-de101007c657/custom-pegasus-trail-gtx-by-you.png' alt='Pegasus Trail' />
        </div>
      </Slider>
    </div>
  );
